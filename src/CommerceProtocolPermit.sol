...
contract CommerceProtocolPermit is CommerceProtocolBase {
    ...
    function createPermitIntent(PlatformPaymentRequest memory request)
        ...
        nonReentrant
        whenNotPaused
        returns (bytes16 intentId, ICommercePaymentsProtocol.TransferIntent memory intent)
    {
        // Validate payment request
        _validatePaymentRequest(request);
    ...
    function batchExecuteWithPermit(
        ...
        ICommercePaymentsProtocol.Permit2SignatureTransferData[] calldata permitDataArray
