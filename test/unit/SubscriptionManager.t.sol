...
contract SubscriptionManagerTest is TestSetup {
    ...
    function test_SubscribeToCreator_Renewal() public {
        ...
        emit SubscriptionRenewed(
            user1, creator1, DEFAULT_SUBSCRIPTION_PRICE, block.timestamp + SUBSCRIPTION_DURATION, 1
        );
    ...
    function test_ExecuteAutoRenewal_Success() public {
        ...
        vm.prank(user1);
        subscriptionManager.configureAutoRenewal(
            creator1, true, DEFAULT_SUBSCRIPTION_PRICE * 2, DEFAULT_SUBSCRIPTION_PRICE * 2
        );
    ...
    function test_ExecuteAutoRenewal_InsufficientBalance() public {
        ...
        vm.prank(user1);
        subscriptionManager.configureAutoRenewal(
            creator1, true, DEFAULT_SUBSCRIPTION_PRICE, DEFAULT_SUBSCRIPTION_PRICE - 1
        );
    ...
    function test_CleanupExpiredSubscriptions_Success() public {
        ...
        SubscriptionManager.SubscriptionRecord memory record1 =
            subscriptionManager.getSubscriptionDetails(user1, creator1);
        SubscriptionManager.SubscriptionRecord memory record2 =
    ...
    function test_WithdrawAutoRenewalBalance_Success() public {
        ...
        vm.prank(user1);
        subscriptionManager.configureAutoRenewal(
            creator1, true, DEFAULT_SUBSCRIPTION_PRICE, DEFAULT_SUBSCRIPTION_PRICE * 2
        );
    ...
    function test_RecordSubscriptionPayment_Success() public {
        ...
        vm.expectEmit(true, true, false, true);
        emit ExternalSubscriptionRecorded(
            user1,
            creator1,
            intentId,
            usdcAmount,
        ...
        subscriptionManager.recordSubscriptionPayment(
            user1, creator1, intentId, usdcAmount, paymentToken, actualAmountPaid
        );
    ...
    function test_RecordSubscriptionPayment_Renewal() public {
        ...
        emit SubscriptionRenewed(
            ...
            creator1,
            usdcAmount,
            subscriptionManager.getSubscriptionEndTime(user1, creator1) + SUBSCRIPTION_DURATION,
            1
        );

        subscriptionManager.recordSubscriptionPayment(
            user1, creator1, intentId, usdcAmount, address(mockUSDC), usdcAmount
        );
    ...
    function test_GetSubscriptionStatus_Success() public {
        ...
        (bool isActive, bool inGracePeriod, uint256 endTime, uint256 gracePeriodEnd) =
            subscriptionManager.getSubscriptionStatus(user1, creator1);
    ...
    function test_GetPlatformSubscriptionMetrics_Success() public {
        ...
        assertEq(
            platformFees,
            calculatePlatformFee(DEFAULT_SUBSCRIPTION_PRICE) + calculatePlatformFee(DEFAULT_SUBSCRIPTION_PRICE * 2)
        );
